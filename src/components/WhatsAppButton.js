...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/25 transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:scale-110 hover:bg-[#1ebe5b] hover:shadow-xl sm:bottom-6 sm:right-6 sm:h-14 sm:w-14"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
